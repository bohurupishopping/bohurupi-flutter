...
class OrderTrackingDialog extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Material(
      ...
      child: Stack(
        children: [
          // Backdrop with gradient and glassmorphism
          AnimatedBuilder(
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Theme.of(context).colorScheme.primary.withOpacity(0.1 * fadeAnimation.value),
                      Theme.of(context).colorScheme.secondary.withOpacity(0.12 * fadeAnimation.value),
                      Theme.of(context).colorScheme.tertiary.withOpacity(0.1 * fadeAnimation.value),
                    ],
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    color: Theme.of(context).colorScheme.scrim.withOpacity(0.32 * fadeAnimation.value),
                  ),
                ),
              ),
            ),
