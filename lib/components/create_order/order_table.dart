...
class _OrderTableStyles {
  ...
  factory _OrderTableStyles.from(ThemeData theme, _ThemeColors colors) {
    return _OrderTableStyles(
      cardDecoration: BoxDecoration(
        color: colors.surfaceOpacity80,
...
class OrderTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Cache styles
    final styles = _OrderTableStyles.from(theme, colors);
...
class _OrderCard extends StatelessWidget {
  ...
  final ThemeData theme;
  final _ThemeColors colors;
  final _OrderTableStyles styles;
...
class _OrderActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: styles.actionDecoration,
      child: Row(
